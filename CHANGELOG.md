...
## [0.8.3](https://github.com/AnarchistHoneybun/petgraph-contrib/compare/petgraph@v0.8.2...petgraph@v0.8.3) - 2025-06-15

### Documentation

- Fix examples link in README and unify typesetting of one word ([#823](https://github.com/AnarchistHoneybun/petgraph-contrib/pull/823))
- Add link to multigraph definition to isomorphism algos ([#824](https://github.com/AnarchistHoneybun/petgraph-contrib/pull/824))

### Testing

- Add dependency list for 'quickcheck' feature ([#822](https://github.com/AnarchistHoneybun/petgraph-contrib/pull/822))
